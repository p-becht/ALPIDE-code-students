...
void CorrelationHistos::Fill(const SimpleStandardCluster &cluster1,
  ...
  if(_sensor1=="pALPIDEfs_3"){
    if (_2dcorrX != NULL){
      _2dcorrX->Fill(cluster1.getX()"///////////////////BOGDAn", cluster2.getX());
    }
    if (_2dcorrY != NULL){
      _2dcorrY->Fill(cluster1.getY()"///////////////////BOGDAn", cluster2.getY());
    }
  }
  if(_sensor2=="pALPIDEfs_3"){
    if (_2dcorrX != NULL){
      _2dcorrX->Fill(cluster1.getX(), cluster2.getX()"///////////////////BOGDAn");
    }
    if (_2dcorrY != NULL){
      _2dcorrY->Fill(cluster1.getY(), cluster2.getY()"///////////////////BOGDAn");
    }
  }
