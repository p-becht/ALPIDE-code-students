    ...
    do
        ...
        do
            ...
            do
                ...
                root -b -l <<EOF
                .L NoiseComparison.C+g
                compare_settings("$DATA_DIR", "run_list.txt", "$CHIP", $TEMP, $IRRAD_LEVEL, "ITHR", $VBB, $VCASN, 10000, 50, $SEC)
EOF
    ...
    do
        ...
        do
            ...
            do
                ...
                root -b -l <<EOF
                .L NoiseComparison.C+g
                compare_vbb("$DATA_DIR", "run_list.txt", "$CHIP", $TEMP, $IRRAD_LEVEL, $ITHR, 10000, 50, $SEC)
EOF
    ...
    do
        ...
        do
           ...
           do
                ...
                root -b -l <<EOF
                .L NoiseComparison.C+g
                compare_temperature("$DATA_DIR", "run_list.txt", "$CHIP", $IRRAD_LEVEL, $VBB, $VCASN, $ITHR, 10000, 50, $SEC)
EOF
        ...
        do
            ...
            do
                ...
                do
                    ...
                    root -b -l <<EOF
                    .L NoiseComparison.C+g
                    compare_chips("$DATA_DIR", "run_list.txt", $TEMP, $IRRAD_LEVEL, $VBB, $VCASN, $ITHR, 10000, 50, $SEC)
EOF
    ...
    do
        ...
        do
            ...
            do
                ...
                root -b -l <<EOF
                .L NoiseComparison.C+g
                compare_irradiation("$DATA_DIR", "run_list.txt", $TEMP, $VBB, $VCASN, $ITHR, 10000, 50, $SEC)
EOF
