void PlotChipsPixelDigital(const TString sDataset="dataset.txt")
{
  if (gSystem->Load("$PA_ROOT/lib/libpAAnalysis")<0) {
    ::Error("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "Can not load lib $PA_ROOT/lib/libpAAnalysis");
    return;
  }
//=============================================================================

  if (gSystem->AccessPathName(sDataset.Data())) {
    ::Error("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "Dataset %s does not exist!", sDataset.Data());
    return;
  }
//=============================================================================
...
//=============================================================================
  ...
  while (!dataList.eof()) {
    ...
    ::Info("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "Chip ID%d: %s", nc, sDataFile.Data());
    sID = CheckChipIdentifier(sDataFile, sFormat);

    for (int i=0; i<=pa->GetNScans(); i++) {
      if (pa->GetScanType(i)!=TpAUtils::SCANTYPE_DIGITAL) continue;
      TpADigitalScan *pScan = (TpADigitalScan*)pa->RetrieveScan(i); if (!pScan) continue;
  ...
  if (ns<=0) return;
  ::Info("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "%d files have been analyzed", nc);
//=============================================================================
...
//=============================================================================
  ...
  can = MakeCanvas("ChipsPixelDigitalScanDead");
  ...
  tex->DrawLatex(0.1, 0.92, "Digital scan, # of dead pixels");
  CanvasEnd(can);
//=============================================================================

  can = MakeCanvas("ChipsPixelDigitalScanInefficient");
  can->SetRightMargin(0.12);
  can->SetBottomMargin(0.2);
  can->SetGridx();
  can->SetGridy();
  ...
  tex->SetNDC();
  tex->SetTextSizePixels(24);
  tex->DrawLatex(0.1, 0.92, "Digital scan, # of inefficient pixels");
  CanvasEnd(can);
//=============================================================================

  can = MakeCanvas("ChipsPixelDigitalScanNoisy");
  can->SetRightMargin(0.12);
  can->SetBottomMargin(0.2);
  can->SetGridx();
  can->SetGridy();
  ...
  tex->SetNDC();
  tex->SetTextSizePixels(24);
  tex->DrawLatex(0.1, 0.92, "Digital scan, # of noisy pixels");
  CanvasEnd(can);
//=============================================================================

  cout << endl;
  ::Info("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "Markdown table");
  ...
  ::Info("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "End of markdonw table");
  cout << endl;
//=============================================================================

  ::Info("PlotChipsPixelDigital.C::PlotChipsPixelDigital", "DONE");
  return;
}
