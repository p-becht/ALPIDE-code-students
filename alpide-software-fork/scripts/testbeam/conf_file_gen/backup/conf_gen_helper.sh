...
# assemble file names
config_file='pALPIDE-2_'${n_file_str}'_VCASN'${vcasn}'_ITHR'${ithr}'_VBB'${vbb}'_DUTpos'$dut_pos'_VAUX'${vaux}'_VRST'${vrst}'_IDB'${idb}'_TRGDLY'${trg_dly}'.conf'
threshold_file='pALPIDE-2_threshold_VCASN'${vcasn}'_ITHR'${ithr}'_VAUX'${vaux}'_VRST'${vrst}'_IDB'${idb}'.xml'
